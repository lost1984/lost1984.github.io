...
<lark-table column-widths="120,120,220,240" header-row="true">
<lark-tr>
<lark-td>
...
总调度、总协调、总收口、总验收、总反馈、总进化

</lark-td>
<lark-td>

深度研发验证、长篇情报分析、复杂代码实现、长期生活陪伴执行
...
信息收集、信息提炼、趋势判断、机会识别、方向洞察、创新建议

</lark-td>
<lark-td>

项目总控、研发验证结论、程序实现、日常节奏管理
...
材料路线比较、实验设计、性能验证、可行性分析、参数优化、工艺平衡

</lark-td>
<lark-td>

项目总调度、宏观趋势分析、程序开发、日常生活支持
...
编程实现、脚本开发、自动化流程、调试修复、工具搭建、数据处理实现

</lark-td>
<lark-td>

项目总控、趋势分析、研发结论判断、日常节奏管理
...
日程安排、轻量提醒、习惯支持、节奏管理、执行陪伴、日常整理

</lark-td>
<lark-td>

总体目标规划、趋势分析、材料研发、编程实现
